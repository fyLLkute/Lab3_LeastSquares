...
if __name__ == "__main__":
    ...
    variances = []
    # Обмежуємо m до 6 для стабільності прогнозу [cite: 82, 165]
    # Високі степені (7-10) спричиняють різкі стрибки при екстраполяції
    ...
    for m in degrees:
        ...
        # Вибір оптимального m за мінімумом дисперсії [cite: 83, 95, 170]
        if var < min_var:
            min_var = var
            best_m = m
            best_coeffs = coeffs
    ...
    # 6. Екстраполяція на 3 наступні періоди [cite: 98, 179-182]
